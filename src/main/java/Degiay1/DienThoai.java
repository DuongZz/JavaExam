...
public class DienThoai extends HangHoa {
    ...
    public DienThoai(String nsx, String dungLuong, String mau, String maHang, String ten, int giaBan) {
    ...
    public static void main(String[] args) {
        ...
        DienThoai dt = new DienThoai(nsx, dungLuong, mau, maHang, mau, giaBan);
